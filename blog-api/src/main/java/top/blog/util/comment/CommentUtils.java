package top.blog.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.blog.config.properties.BlogProperties;
import top.blog.constant.PageConstants;
...
import top.blog.service.AboutService;
import top.blog.service.BlogService;
import top.blog.service.FriendService;
...
import top.blog.util.MailUtils;
import top.blog.util.QQInfoUtils;
import top.blog.util.StringUtils;
import top.blog.util.comment.channel.ChannelFactory;
import top.blog.util.comment.channel.CommentNotifyChannel;
import top.blog.enums.CommentOpenStateEnum;
import top.blog.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.blog.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.blog.entity.Comment parentComment, Comment comment) {
