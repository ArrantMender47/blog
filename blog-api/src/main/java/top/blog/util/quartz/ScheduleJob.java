package top.blog.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.blog.entity.ScheduleJobLog;
import top.blog.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.blog.entity.ScheduleJob scheduleJob = (top.blog.entity.ScheduleJob) context.getMergedJobDataMap().get(top.blog.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
