package top.blog.controller.admin;
...
import top.blog.annotation.OperationLogger;
...
import top.blog.service.CategoryService;
import top.blog.service.CommentService;
import top.blog.service.TagService;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.blog.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.blog.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.blog.model.dto.Blog blog, String type) {
		//验证普通字段
